"""
Test para datos reales de CountMin, CountMinSketch y CountMinCU
Estimación de Heavy-Hitters con datos reales de proteinas
cm: CountMin, 
cs: CountSketch, 
cmcu: CountMinCU
...
largo, data = dg.kmers(k=10, n=1000, path_to_file=path)
